...
main = do
  ...
  quickCheck $ ([2.3, 1, 2, 1_000] :: [Double]) =~ [2.3, 1, 2, 1e+3]
  quickCheck $ ([1.0, 1.0, 1.0, 1.0] :: [Double]) /~ [1.0, 1.0, 1.0, 1.0, 2.0]

  quickCheck $ ((1.2, 3.4) :: (Double, Double)) =~ (1.200_000_08, 3.399_999_999)
  quickCheck $ ((1.2, 3.5) :: (Double, Double)) /~ (1.200_00008, 3.399_999999)

  quickCheck $ ((1.2, 3.4, 2.5) :: (Double, Double, Double)) =~ (1.200_00008, 3.399_999999, 2.500_0001)
  quickCheck $ ((1.2, 3.4, 2.5) :: (Double, Double, Double)) /~ (1.2, 3.399_999999, 2.4)

  quickCheck $ ((1.2, 3.4, 2.5) :: (Float, Float, Float)) =~ (1.200_00008, 3.399_999999, 2.500_0001)
  quickCheck $ ((1.2, 3.4, 2.5) :: (Float, Float, Float)) /~ (1.2, 3.399_999999, 2.4)
  ...
  quickCheck $ fromGregorian 2_018 3 30 =~ fromGregorian 2_018 3 30
  quickCheck $ fromGregorian 2_018 3 31 /~ fromGregorian 2_018 3 30
  ...
  quickCheck $ U.fromList ([2.5, 1.5, 3.56] :: [Double]) =~ U.fromList [2.500_000001, 1.5, 3.56]
